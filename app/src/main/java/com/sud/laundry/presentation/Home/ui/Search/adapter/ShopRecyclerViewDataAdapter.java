...
public class ShopRecyclerViewDataAdapter extends RecyclerView.Adapter<ShopRecyclerViewDataAdapter.HomeParentItemRowHolder> {

    private List<ProductDetailsItem> productDetailsItemArrayList;
    private Context mContext;
    ShopRowClickInterface shopRowClickInterface;

    public ShopRecyclerViewDataAdapter(Context context, ShopRowClickInterface shopRowClickInterface) {
    ...
    public void onBindViewHolder(HomeParentItemRowHolder itemRowHolder, int i) {
        ...
        ShopChildRecycleViewDataAdapter itemListDataAdapter = new ShopChildRecycleViewDataAdapter(mContext, proListItemList, shopRowClickInterface);
        ...
        itemRowHolder.tv_compeny_name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                shopRowClickInterface.homeRowclick(0,  productDetailsItem,null);
            }
        });
