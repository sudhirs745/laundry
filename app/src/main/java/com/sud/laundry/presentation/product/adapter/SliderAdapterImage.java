...
public class SliderAdapterImage extends SliderViewAdapter<SliderAdapterImage.SliderAdapterVH> {
    ...
    private List<ProImageListItem> mSliderItems = new ArrayList<>();

    public SliderAdapterImage(Context context) {
        this.context = context;
    }

    public void renewItems(List<ProImageListItem> sliderItems) {
    ...
    public void addItem(ProImageListItem sliderItem) {
    ...
    public void onBindViewHolder(SliderAdapterVH viewHolder, final int position) {
        ...
        ProImageListItem sliderItem = mSliderItems.get(position);
...
//        viewHolder.textViewDescription.setTextColor(Color.WHITE);
        ...
        Glide.with(viewHolder.itemView)
                .load(NetworkClient.IMAGE_URL+sliderItem.getImgUrl())
