...
public class MainCategoryAdapter extends RecyclerView.Adapter<MainCategoryAdapter.MyView> {

    private List<SubcatItem> categoriesItemList;
    Context mContext;
    HomeRowClickInterface homeRowClickInterface ;
    public MainCategoryAdapter(List<SubcatItem> categoriesItemList, Context mContext , HomeRowClickInterface homeRowClickInterface  ) {
